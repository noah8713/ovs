 ...
 * supported options in environment variable.  On success, stores the parsed
 * env variables in 'argv', the number of options in 'argc', and returns NULL.
 * On failure, returns an error message and zeros the output arguments. */
char **
